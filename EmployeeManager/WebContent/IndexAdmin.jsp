			        ...
			        <div class="container clear">
			            ...
			            <div class="collapse navbar-collapse clear" id="navbar-left">
			                <ul class="nav navbar-nav clear">
			                    <li class="active-menu"><a href="/EmployeeManager/IndexAdmin.html">Trang chủ</a></li><br>
			...
			<div class="col-sm-10 clear" style="height:600px;background:#eeeeee;">
				...
				<div class="panel-group">
		            <div class="panel panel-primary">
		                <div class="panel-heading"><h2>Trang chủ admin</h2></div>
		                <div class="panel-body">
		                    <h4>- Trang admin với username = <%=session.getAttribute("username") %>.</h4>
		                </div>
		            </div>
		        </div>
			</div>
